...
/*********************需要修改的地方**********************/
const char* ssid = "OpenWrt-2.4G";           //WIFI名称
...
const char*  uid = "4eacc0f55636840afb50e11a03a3b065";    //用户私钥，巴法云控制台获取
const char*  topic = "img";     //主题名字，可在控制台新建
...
const char* mqtt_server = "119.91.122.58"; 
const char* TOPIC = "mqttx/pic"; // 订阅信息主题
const char* client_id = "ESP32-CAM";
